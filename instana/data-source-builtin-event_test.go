		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(testBuiltInEventSpecDataSource, BuiltinEventSpecificationFieldEnabled, trueAsString),
					resource.TestCheckResourceAttr(testBuiltInEventSpecDataSource, BuiltinEventSpecificationFieldTriggering, falseAsString),
				),
			},
		},
	})
