...
func (m *tagFilterMapperImpl) ToAPIModel(input *FilterExpression) restapi.TagFilterExpressionElement {
	return m.mapLogicalOrToAPIModel(input.Expression)
}

func (m *tagFilterMapperImpl) mapLogicalOrToAPIModel(input *LogicalOrExpression) restapi.TagFilterExpressionElement {
...
func (m *tagFilterMapperImpl) mapLogicalAndToAPIModel(input *LogicalAndExpression) restapi.TagFilterExpressionElement {
...
func (m *tagFilterMapperImpl) unwrapExpressionElements(element restapi.TagFilterExpressionElement, operator restapi.LogicalOperatorType) []restapi.TagFilterExpressionElement {
...
func (m *tagFilterMapperImpl) mapPrimaryExpressionToAPIModel(input *PrimaryExpression) restapi.TagFilterExpressionElement {
...
func (m *tagFilterMapperImpl) mapUnaryOperatorExpressionToAPIModel(input *UnaryOperationExpression) restapi.TagFilterExpressionElement {
...
func (m *tagFilterMapperImpl) mapComparisonExpressionToAPIModel(input *ComparisonExpression) restapi.TagFilterExpressionElement {
