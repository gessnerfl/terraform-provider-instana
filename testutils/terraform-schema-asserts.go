...
type TerraformSchemaAssert interface {
	...
	//AssertSchemaIsComputedAndOfTypeListOfStrings checks if the given schema field is computed and of type list of string
	AssertSchemaIsComputedAndOfTypeListOfStrings(fieldName string)
	...
	//AssertSchemaIsComputedAndOfTypeSetOfStrings checks if the given schema field is computed and of type set of string
	AssertSchemaIsComputedAndOfTypeSetOfStrings(fieldName string)
	...
	//AssertSchemaIsComputedAndOfTypeMapOfStrings checks if the given schema field is computed and of type list of string
	AssertSchemaIsComputedAndOfTypeMapOfStrings(fieldName string)
	...
	//AssertSchemaIsComputedAndOfTypeListOfResource checks if the given schema field is computed and of type list of resource
	AssertSchemaIsComputedAndOfTypeListOfResource(fieldName string)
...
func (inst *terraformSchemaAssertImpl) AssertSchemaIsComputedAndOfTypeListOfStrings(schemaField string) {
	s := inst.schemaMap[schemaField]

	require.NotNil(inst.t, s)
	require.False(inst.t, s.Required)
	require.False(inst.t, s.Optional)
...
func (inst *terraformSchemaAssertImpl) AssertSchemaIsComputedAndOfTypeListOfResource(schemaField string) {
	s := inst.schemaMap[schemaField]
...
func (inst *terraformSchemaAssertImpl) AssertSchemaIsComputedAndOfTypeSetOfStrings(schemaField string) {
	s := inst.schemaMap[schemaField]
...
func (inst *terraformSchemaAssertImpl) AssertSchemaIsComputedAndOfTypeMapOfStrings(schemaField string) {
	s := inst.schemaMap[schemaField]
